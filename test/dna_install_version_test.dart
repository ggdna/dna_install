...
void main() {
  group('dna_install_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/dna_install_version.dart');
